...
function initPlayer()
    ...
    playerAxe = getGameObject(player.x,player.y, 0, 0, PLAYER_AXE_SIZE,0)
    playerAxe.vx, playerAxe.vy = 0, 0
end
...
function loadGraphics()
    ...
    playerSprites = {}
    playerSprites[0] = love.graphics.newImage("res/player-head.png")
    playerSprites[1] = love.graphics.newImage("res/player-body.png")
